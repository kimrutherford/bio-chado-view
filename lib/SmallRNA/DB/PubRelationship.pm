package SmallRNA::DB::PubRelationship;
...
__PACKAGE__->belongs_to("subject", "SmallRNA::DB::Pub", { pub_id => "subject_id" });
__PACKAGE__->belongs_to("type", "SmallRNA::DB::Cvterm", { cvterm_id => "type_id" });
__PACKAGE__->belongs_to("object", "SmallRNA::DB::Pub", { pub_id => "object_id" });


# Created by DBIx::Class::Schema::Loader v0.04005 @ 2009-06-18 14:03:57
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:luUhsd8o0t4u39c+3Ge0jQ
