package SmallRNA::DB::CvtermRelationship;
...
__PACKAGE__->belongs_to("object", "SmallRNA::DB::Cvterm", { cvterm_id => "object_id" });
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hJ9jpyqkQ9VJ10nJx11NVQ
