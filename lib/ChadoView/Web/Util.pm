package ChadoView::Web::Util;

=head1 NAME

ChadoView::Web::Util - Utilities for the web code
...
sub get_field_value
{
  ...
  my $parent_class_name = ChadoView::DB::class_name_of_table($type);
