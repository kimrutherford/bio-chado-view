package ChadoView::Config;

=head1 NAME

ChadoView::Config - Configuration information for ChadoView Perl code
...
=head2 new
 ...
 Usage   : my $config = ChadoView::Config->new($file_name);
       or: my $config = ChadoView::Config->new();
